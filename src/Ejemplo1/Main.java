package Ejemplo1;
/*
 * Una condición de carrera ocurre cuando dos o más hilos acceden a un recurso compartido (como una variable o un objeto) al mismo tiempo, 
 ...
 * Si ambos leen el valor actual de la variable antes de que cualquiera de ellos la incremente, ambos podrían leer el mismo valor y luego 
